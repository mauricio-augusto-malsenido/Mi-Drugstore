...
public class AdaptadorLineasPedidoDetalle extends BaseAdapter {
    ...
    public AdaptadorLineasPedidoDetalle(Context contexto, List<LineaPedidoCompra> lista) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (vista == null)
        {
            ...
            vista = inflater.inflate(R.layout.item_lista_lineas_detalle_pedido,null);
